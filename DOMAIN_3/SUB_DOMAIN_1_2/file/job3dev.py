...
job_name = "job3dev"
pipeline_id = 3
pipeline_name = 'job3dev' 
flex_template = 'csv_flex_template.json'  
stage = 'dev'  
dataflow_bucket_name = 'demo_dwh_bkt'ç
    ...
    data = {
        "launch_parameter": {
            ...
            "parameters": {
                ...
                "origin_bucket": f'{origin_bucket}',
                'prefix': f'{prefix}',
                'filename': f'{filename}',
                'sufix': f'{sufix}',
                'separator': f'{separator}',
                'ext': f'{ext}',
                'datetime_format': f'{datetime_format}',
                'delimitator': f'{delimitator}',
                'date_field_name': f'{date_field_name}',
                'allow_multi_date': f'{allow_multi_date}',
                'allow_accum_date': f'{allow_accum_date}',
                'allow_multi_file': f'{allow_multi_file}'
            },
        }
    }
