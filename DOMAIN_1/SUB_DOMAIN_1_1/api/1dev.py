...
#datos Generales
job_name = "Job1dev_dev"
pipeline_id = 1
pipeline_name = '1dev'
flex_template = 'hana_flex_template.json'
stage = 'dev'
secret_name_origin = 'hanasecret'
query = 'Select id, price, total_prod, name, products, price, params, createdAt, state, shippingDeadline, totalPrice, guideState, leadtimeToShipLate, deliveryCenter, requestedWithError, fulfillment, fulfillmentCenter, fulfillmentCenter, offer-id, product-sku, min-shipping-price, min-shipping-price-additional, min-shipping-zone, min-shipping-type, price from "DWH_AUTOMATION".orders'
