...
query = 'Select createdAt, state, shippingDeadline, totalPrice, guideState, leadtimeToShipLate, deliveryCenter, requestedWithError, fulfillment, fulfillmentCenter, id.value from "DWH_AUTOMATION".orders'
